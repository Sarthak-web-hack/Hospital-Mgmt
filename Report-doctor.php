<?php
   ...
   if(isset($_GET['delete_id']))
   {
      ...
      if($db->delete_doctor_details($delete_id))
      {
         $flag =  3;
      }
   }
...
<body>
    ...
    <div class="container-fluid bg-primary py-5 hero-header mb-5">
        <div class="row py-3">
            <div class="col-12 text-center">
                <h1 class="display-3 text-white animated zoomIn">Doctor Report</h1>
                <a href="" class="h4 text-white">Home</a>
                <i class="far fa-circle text-white px-2"></i>
                <a href="" class="h4 text-white">Doctor Report</a>
            </div>
        </div>
    </div>
    <!-- Hero End -->
  ...
  <div class="card-header d-flex justify-content-between flex-wrap" >
                <div class="header-title">
                    <h4 class="card-title mb-0">Doctor Report</h4>
                </div>
                ...
                <th class="text-center">Delete</th>
                     ...
                     ?>
                        ...
                        <td class=""><?php 
                                ...
                                {
                                    ?>
                                    <a href="doctor_profiles/<?php echo $profile_photo; ?>" target="_blank">
                                    <img src="doctor_profiles/<?php echo $profile_photo; ?>" style="height:100px; width:100px;" />
                                    </a>
                                    <?php
                                } 
                                ?></td>
                        <td class=""><?php echo $qualification; ?></td>

                        <td class=""><?php echo $specialist; ?></td>

                        <td class=""><?php echo $exp; ?></td>

                        <td class=""><?php echo $profile_description; ?></td>

                        <td class=""><?php echo $m_no; ?></td>
                        ...
                        <td class=""><?php echo $time; ?></td>
                                ...
                                <td class="text-center">
                                    <a class="btn btn-sm btn-icon text-primary flex-end" data-bs-toggle="tooltip" title="Edit User" href="edit-doctor.php?edit_id=<?php echo $res_id; ?>">
